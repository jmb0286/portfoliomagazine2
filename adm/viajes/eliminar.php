...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(empty($idViaje)){
        $notificacion = "Error: El id del Viaje está vacio";
    }else{
...
<section class="eliminar py-4">
    <div class="container">
    <h1 class="text-center">Eliminar Viajes</h1>
    ...
    <hr>
        ...
        <form action="eliminar.php" method="POST" class="col-6 mx-auto p-5 bg-dark text-white text-center">
            ...
            <label for="" class="d-block">Está seguro de eliminar el viaje seleccionado?</label>
