                ...
                <?php 
                    while ($categoria = $categorias->fetch_assoc()) {
                        echo '<tr>
                            ...
                            <td>
                                <a href="modificar.php?id='.$categoria['idCategoria'].'" class="btn btn-success">Modificar</i></a>
                                <a href="eliminar.php?id='.$categoria['idCategoria'].'" class="btn btn-danger">Eliminar</a>
                            </td>
                        </tr>';
                    }
                ?>
